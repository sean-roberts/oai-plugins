...
If you hit an issue with the upstream content itself, file it in [vercel/vercel-plugin](https://github.com/vercel/vercel-plugin/issues). If the issue is specific to this marketplace packaging or Codex compatibility layer, fix it here in `openai/plugins`.
